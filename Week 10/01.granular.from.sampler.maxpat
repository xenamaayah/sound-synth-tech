...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.75, 82.0, 90.0, 22.0 ],
					"text" : "loadmess 1986"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.0, 82.0, 90.0, 22.0 ],
					"text" : "loadmess 1612"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.25, 82.0, 90.0, 22.0 ],
					"text" : "loadmess 5281"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.5, 260.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.5, 292.5, 48.0, 22.0 ],
					"text" : "loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.5, 378.0, 56.0, 22.0 ],
					"text" : "r velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.5, 397.833333333333371, 41.0, 22.0 ],
					"text" : "r pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.5, 223.5, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 160.0, 90.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.5, 257.5, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 36.5, 588.0, 34.0, 22.0 ],
					"text" : "*~ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.166670262813568, 629.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.5, 629.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 37.5, 462.0, 48.0, 136.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 495.600000000000023, 321.666687000000024, 240.0, 321.666687000000024 ],
					"order" : 1,
					"source" : [ "obj-68", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.399999999999977, 255.0, 387.0, 255.0, 387.0, 343.0, 143.5, 343.0 ],
					"order" : 2,
					"source" : [ "obj-68", 2 ]
				}
