...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.5, 408.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.0, 408.0, 90.0, 20.0 ],
					"text" : "current event #"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 201.0, 373.0, 113.5, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.25, 203.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 560.25, 178.0, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 560.25, 235.0, 100.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 560.25, 268.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 268.0, 29.5, 22.0 ],
					"text" : "dec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 268.0, 29.5, 22.0 ],
					"text" : "inc"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 201.0, 206.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 201.0, 342.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 201.0, 313.0, 498.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 201.0, 242.0, 238.0, 22.0 ],
					"text" : "sel 32 28 29"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.5, 174.0, 178.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 201.0, 174.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 176.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 146.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 451.0, 5.0, 173.0, 74.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 314.200005888938904, 350.0, 192.0, 33.0 ],
									"text" : "<= make corresponding receive objects in your patches"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 170.700005888938904, 236.0, 194.0, 33.0 ],
									"text" : "<= select your MIDI device onces its plugged in and turned on"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 4.200005888938904, 309.0, 64.5, 20.0 ],
									"text" : "activity =>"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 137.700005888938904, 175.0, 227.0, 33.0 ],
									"text" : "<= resend controllers message anytime you connect or disconnect a MIDI device"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 63.700005888938904, 309.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 131.700005888938904, 309.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.700005888938904, 309.0, 50.0, 22.0 ]
								}

							}
, 							{
								"box" : 								{
									"color" : [ 0.870588235294118, 0.298039215686275, 0.066666666666667, 1.0 ],
									"id" : "obj-3",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 252.200005888938904, 350.0, 60.0, 22.0 ],
									"text" : "s channel"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.168627450980392, 0.290196078431373, 0.701960784313725, 1.0 ],
									"id" : "obj-13",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.200005888938904, 350.0, 58.0, 22.0 ],
									"text" : "s velocity"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.23921568627451, 0.592156862745098, 0.019607843137255, 1.0 ],
									"id" : "obj-12",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 112.200005888938904, 350.0, 43.0, 22.0 ],
									"text" : "s pitch"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 112.200005888938904, 271.0, 159.0, 22.0 ],
									"text" : "notein"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 71.700005888938904, 236.0, 100.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 71.700005888938904, 205.0, 50.0, 22.0 ],
									"text" : "midiinfo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 71.700005888938904, 175.0, 64.0, 22.0 ],
									"text" : "controllers"
								}
...
, 							{
								"box" : 								{
									"color" : [ 0.980392156862745, 0.576470588235294, 0.023529411764706, 1.0 ],
									"id" : "obj-4",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 71.700005888938904, 145.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.700005888938904, 69.400000512599945, 529.0, 74.0 ],
...
,
					"patching_rect" : [ 11.0, 204.0, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 162.0, 106.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 46.0, 162.0, 91.0, 22.0 ],
									"text" : "r chooser.menu"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 186.0, 80.0, 22.0 ],
									"text" : "r current.path",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 96.0, 215.0, 240.5, 20.0 ],
									"text" : "<= stores a list (right), bang it out later (left)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 49.0, 215.0, 38.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 494.0, 114.0, 82.0, 22.0 ],
									"text" : "s current.path",
									"textcolor" : [ 1.0, 0.976470588235294, 0.976470588235294, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 446.0, 50.0, 59.0, 22.0 ],
									"text" : "r get.path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 510.0, 50.0, 32.0, 22.0 ],
									"text" : "path"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 446.0, 86.0, 67.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 392.5, 360.0, 35.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									"autopopulate" : 1,
									"id" : "obj-21",
									"items" : [ "648437__timouse__piano-loop-21.wav", ",", "harp-glissando-up.aiff", ",", "Vn-jette-E5-mf.aif" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									...
									"prefix" : "~/Desktop/Senior 2022-2023/Semester 1/Sound Synthesis Techniques/sound-synth-tech/Week 14/magnum.opus.boiler/media/"
								}
...
,
					"patching_rect" : [ 11.0, 261.0, 70.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 11.0, 344.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 139.0, 165.0, 49.0 ],
													"text" : ";\rping.high.ms 200;\rprinter.thingy \"... even faster!\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 18.0, 101.0, 67.0, 22.0 ],
													"text" : "delay 3000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 274.5, 139.0, 241.0, 49.0 ],
													"text" : ";\rping.high.ms 400;\rprinter.thingy \"Increasing density of pings...\""
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 292.0, 115.0, 200.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 18.0, 62.0, 275.5, 22.0 ],
													"text" : "b 2"
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 139.0, 198.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 18.0, 101.0, 74.0, 22.0 ],
													"text" : "delay 10000"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 274.5, 139.0, 210.0, 62.0 ],
													"text" : ";\rpring.process.switch 1;\rpring.out.gain -70., 0., 10000;\rprinter.thingy \"Fading in pings, 10s ...\""
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 215.400146500000005, 304.0, 89.0 ],
													"text" : ";\rprinter.thingy \"Sending initial ping values ...\";\rping.low.ms 100;\rping.high.ms 900;\rping.click.gain 23;\rprinter.thingy \"INIT COMPLETE! Ready for Event #1 ...\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 458.75, 215.400146500000005, 412.0, 62.0 ],
													"text" : ";\rget.path path;\rinit.cues.opening bang;\rinit.spat.settings bangl printer.thingy \"Loading sound files and spat settings.\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 899.5, 215.400146500000005, 240.0, 129.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 482.636363636363626, 193.099853499999995, 183.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 1163.0, 155.0, 198.5, 87.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 1163.0, 277.900146500000005, 68.0, 22.0 ],
													"text" : "line -70. 20"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1163.0, 248.900146500000005, 50.0, 22.0 ],
													"text" : "r fader1"
												}
...
, 											{
												"box" : 												{
													...
													"parameter_enable" : 1,
													"patching_rect" : [ 1163.0, 307.900146500000005, 48.0, 136.0 ],
													"saved_attribute_attributes" : 													{
														"valueof" : 														{
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1244.5, 248.900146500000005, 117.0, 49.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 887.5, 188.5, 252.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "bang" ],
													"patching_rect" : [ 18.0, 155.0, 900.5, 22.0 ],
													"text" : "b 3"
												}
...
,
					"patching_rect" : [ 11.0, 234.0, 67.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 86.700005888938904, 681.0, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 12.700005888938904, 714.0, 93.0, 22.0 ],
									"text" : "lg.vol.util.v01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 12.700005888938904, 521.0, 67.0, 22.0 ],
									"text" : "lg.ping.v02"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.700005888938904, 761.000008523464203, 61.0, 22.0 ],
									"text" : "send~ in1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 12.700005888938904, 550.0, 48.0, 136.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
,
					"patching_rect" : [ 11.0, 289.0, 43.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
									"patching_rect" : [ 29.999999999999886, 216.0, 432.000000000000057, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 466.963363647460938, 296.5, 149.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.0, 381.5, 380.374999999999943, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 9,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
									"patching_rect" : [ 29.999999999999943, 296.5, 432.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 501.305045127868652, 197.5, 91.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 501.305045127868652, 221.5, 136.0, 22.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 84.0, 581.0, 68.0, 22.0 ],
									"text" : "send~ out2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.000000000000057, 581.0, 68.0, 22.0 ],
									"text" : "send~ out1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 29.687499999999972, 444.0, 200.0, 118.0 ],
									"relative" : 1,
									"saved_attribute_attributes" : 									{
										"focusbordercolor" : 										{
											"expression" : ""
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-10", 0 ],
									"midpoints" : [ 510.805045127868652, 264.0, 39.499999999999943, 264.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 476.463363647460938, 343.0, 39.5, 343.0 ],
									"source" : [ "obj-14", 0 ]
								}
...
,
					"patching_rect" : [ 11.0, 317.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 356.5, 300.0, 210.5, 300.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 283.5, 300.0, 210.5, 300.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Desktop/Senior 2022-2023/Semester 1/Sound Synthesis Techniques/sound-synth-tech/Week 14/magnum.opus.boiler",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
